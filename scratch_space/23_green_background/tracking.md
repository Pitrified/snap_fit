...
- Implement optional HSV green-mask override before building generic
...
| #  | Phase                                  | Plan                                        | Status  |
| -- | -------------------------------------- | ------------------------------------------- | ------- |
| 1  | Minimal config contract                | [01_minimal_config_contract.md](01_minimal_config_contract.md) | draft |
